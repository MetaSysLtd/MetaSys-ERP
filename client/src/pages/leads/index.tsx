...
export default function LeadsPage() {
  ...
  const handleStatusChange = (value: string) => {
    ...
    setLocation(newSearch ? `?${newSearch}` : "/leads", { replace: true });
  };
  ...
  const canCreateLead = role && (role.department === "sales" || role.department === "admin");
  
  if (isLoading) {
    return (
      <div className="flex h-full items-center justify-center p-8">
        <div className="text-center">
          <h3 className="text-lg font-medium text-gray-900">Loading leads...</h3>
